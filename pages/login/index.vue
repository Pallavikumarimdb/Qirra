<template>
    <div class="min-h-screen flex items-center justify-center bg-muted px-4">
      <Card class="w-full max-w-md p-6 shadow-2xl rounded-2xl bg-background">
        <CardHeader>
          <CardTitle class="text-2xl font-bold text-center">Login to Qirra</CardTitle>
          <CardDescription class="text-center">Enter your credentials to continue</CardDescription>
        </CardHeader>
        ...
        <CardFooter class="flex flex-col space-y-2">
          ...
          <p class="text-sm text-muted-foreground text-center">
            ...
            <NuxtLink to="/register" class="text-primary underline ml-1">Register</NuxtLink>
          </p>
        </CardFooter>
      </Card>
    </div>
